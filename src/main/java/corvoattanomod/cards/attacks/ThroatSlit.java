...
public class ThroatSlit extends BaseCard {
    public static final String ID = makeID("ThroatSlit");
    ...
    {
        boolean triggersMeleeBonus = SpecialBonuses.checkMelee();
        if (CorvoCharacter.stealthStance)
        {
            if (triggersMeleeBonus)
            {
                this.fear(p);
            }
    ...
    public void fear(AbstractPlayer p)
    {
